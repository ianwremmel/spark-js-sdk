...
/**
 * @class
 * This is the main container for the Cisco Spark JavaScript SDK. It provides
 * an http client and access to the storage layer as well as access to all
 * registered plugins
 */
const SparkCore = AmpState.extend({
  ...
  children: {
    /**
     * Mount-point for undocumented internal plugins
     * @instance
     * @memberof SparkCore
     * @private
     * @type {SparkInternalCore}
     */
  ...
  derived: {
    /**
     * Provides access to the bounded storage system. Bounded storage is a
     * key-value store for small keyspace values (credentials, device
     * registation, etc)
     * @instance
     * @memberof SparkCore
     * @type {Object}
    ...
    /**
     * Provides access to the unbounded storage system. Unbounded storage is a
     * key-value store for large keyspace values (e.g. url->encryption keys)
     * @instance
     * @memberof SparkCore
     * @type {Object}
     */
    ...
    /**
     * False until the storage system and plugins have initialized.
     * @instance
     * @memberof SparkCore
     * @type {boolean}
     */
  ...
  session: {
    ...
    /**
     * Makes network requests to the Cisco Spark API. See @ciscospark/http-core
     * for details
     * @instance
     * @memberof SparkCore
     * @type {Function}
    ...
    /**
     * Basis for the spark tracking id
     * @instance
     * @memberof SparkCore
     * @type {string}
     */
  ...
  /**
   * Refreshes the current access token(s)
   * @instance
   * @memberof SparkCore
  ...
  /**
   * Wrapper around {@link SparkCore#request} for doing three-phase upload.
   * Takes the same options Object as {@link SparkCore#request} with the
   * addition  of a  `phases` property. `phases` is an object that may contain
   * objects keyed with `initialize`, `upload`, `finalize`. Each phase entry
   * may override the top level options by providing keys of the same value.
   * Further, keys prefixed with a `$` are evaluated as functions that receive
   * the result of the initalize phase and return a scalar value.
   * @instance
   * @memberof SparkCore
   * @param {Object} options
   * @returns {Promise}
  ...
  /**
   * Executes {@link SparkCore#upload}'s initialize phase
   * @instance
   * @memberof SparkCore
   * @private
   * @param {Object} options
  ...
  /**
   * Merges keys prefixed with `$` with the session returned during the
   * initialize phase.
   * @instance
   * @memberof SparkCore
   * @private
  ...
  @retry
  /**
   * Executes {@link SparkCore#upload}'s upload phase
   * @instance
   * @memberof SparkCore
   * @private
   * @param {Object} options
  ...
  /**
   * Executes {@link SparkCore#upload}'s finalize phase
   * @instance
   * @memberof SparkCore
   * @private
   * @param {Object} options
...
/**
 * Registers a plugin with SparkCore
...
/**
 * Registers a non-productized plugin with SparkCoreInternal
