...
function makeSpark(options) {
  ...
  Object.keys(options.children).forEach(function assignChildren(key) {
  ...
  _.defaults(spark, {
    credentials: {
      ...
      getClientToken: sinon.stub().returns(Promise.resolve({toString: function toString() {
        return 'Basic NOTATOKEN';
      }}))
    },
